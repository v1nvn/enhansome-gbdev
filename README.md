...
A curated list of awesome Game Boy (Color) Development resources, tools, docs, related projects and open-source ROMs. Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 475,581 | 🐛 81 | 📅 2026-06-02 list thing.
...
> #### Game Boy Advance
>
> Game Boy Advance development is covered by another project, the [awesome-gbadev](https://github.com/gbdev/awesome-gbadev) ⭐ 1,310 | 🐛 6 | 📅 2026-01-30 list.
...
* [The Cycle-Accurate Game Boy Docs](https://github.com/AntonioND/giibiiadvance/blob/master/docs/TCAGBD.pdf) ⭐ 211 | 🐛 0 | 🌐 C | 📅 2026-01-25 - A precise documentation by AntonioND to make a cycle-accurate Game Boy emulator.
...
* [Related custom hardware](https://github.com/Gekkio/gb-hardware) ⭐ 370 | 🐛 1 | 🌐 Shell | 📅 2023-07-20 - by Gekkio.
...
* [dmg-schematics](https://github.com/msinger/dmg-schematics) ⭐ 40 | 🐛 2 | 🌐 KiCad Schematic | 📅 2026-05-18 - Schematics and annotated overlay for the DMG-CPU B chip, extracted from die photos, made with KiCad. Also contains Electric VLSI library with layouts for some of the cells and memories.
...
* [Edge of Emulation](https://shonumi.github.io/articles.html), a series of articles about emulating and investigating Game Boy accessories. Also available as [technical documents](https://github.com/shonumi/gbe-plus/tree/master/src/docs/technical) ⭐ 591 | 🐛 80 | 🌐 C++ | 📅 2026-06-10 in the GBE- emulator documentation.
...
* [Arduino Game Boy Printer Emulator](https://github.com/mofosyne/arduino-gameboy-printer-emulator) ⭐ 363 | 🐛 3 | 🌐 C++ | 📅 2026-05-13 - Emulating a Game Boy Printer via the Game Boy Link cable with an Arduino.
...
* [AntonioND's docs](https://github.com/AntonioND/giibiiadvance/tree/master/docs) ⭐ 211 | 🐛 0 | 🌐 C | 📅 2026-01-25 - Corrected schematics and infos on cartridge header data.
...
* [Emulation of Nintendo Game Boy](https://github.com/Baekalfen/PyBoy/blob/master/extras/PyBoy.pdf) ⭐ 5,152 | 🐛 32 | 🌐 Python | 📅 2026-06-05 - Overview of the Game Boy hardware with the perspective of building an emulator.
* [Game Boy Doctor](https://github.com/robert/gameboy-doctor) ⭐ 279 | 🐛 6 | 🌐 Python | 📅 2024-10-06 - A command line tool for comparing logs from your emulator to those from a known-correct one. Useful for line-by-line debugging of Blargg's test ROMs.
...
* [dmg-acid2](https://github.com/mattcurrie/dmg-acid2) ⭐ 237 | 🐛 6 | 🌐 Assembly | 📅 2024-05-23 and [cgb-acid2](https://github.com/mattcurrie/cgb-acid2) ⭐ 87 | 🐛 1 | 🌐 Assembly | 📅 2021-02-26 - Basic PPU rendering tests.
...
* [RGBDS](https://github.com/gbdev/rgbds) ⭐ 1,618 | 🐛 76 | 🌐 C++ | 📅 2026-06-09 - Assembler and linker package. [Documentation](https://rgbds.gbdev.io).
* [wla-dx](https://github.com/vhelin/wla-dx) ⭐ 597 | 🐛 40 | 🌐 Assembly | 📅 2026-06-13 - Yet Another GB-Z80/Z80/... Multi Platform Cross Assembler Package. [Documentation](http://www.villehelin.com/wla.txt).
...
* [GBDK](https://github.com/gbdk-2020/gbdk-2020/) ⭐ 2,245 | 🐛 12 | 🌐 C | 📅 2026-06-12 - Maintained and modernized GBDK (Game Boy Development Kit) powered by an updated version of the SDCC toolchain. Provides a C compiler, assembler, linker and a set of libraries.
...
* [Wiz](https://github.com/wiz-lang/wiz) ⭐ 433 | 🐛 75 | 🌐 C++ | 📅 2025-04-10 - A high-level assembly language for writing homebrew on retro console platforms (Game Boy, NES, Atari 2600, and more).
* [Rust-GB](https://github.com/zlfn/rust-gb) ⭐ 260 | 🐛 0 | 🌐 Rust | 📅 2026-06-07 - A compiler and library that enable the development of GB ROMs using Rust.
...
* [mGBA](https://github.com/mgba-emu/mgba) ⭐ 7,098 | 🐛 836 | 🌐 C | 📅 2026-06-11 - Modern cross platform GBA emulator which also runs GB/GBC games.

* [SameBoy](https://github.com/LIJI32/SameBoy) ⭐ 2,108 | 🐛 158 | 🌐 C | 📅 2026-03-04 - Accurate emulator with a wide range of powerful debugging features.

* [MetroBoy](https://github.com/aappleby/MetroBoy) ⭐ 1,164 | 🐛 4 | 🌐 C++ | 📅 2025-02-23 - A playable, circuit-level simulation of an entire Game Boy.

* [Mooneye GB](https://github.com/Gekkio/mooneye-gb) ⭐ 966 | 🐛 43 | 🌐 Rust | 📅 2023-03-16 - Research project and emulator in Rust.

* [Binjgb](https://github.com/binji/binjgb) ⭐ 602 | 🐛 14 | 🌐 C | 📅 2026-05-26 - 5Kloc emulator that passes most of the tests. \*Rewind- feature. Runs in the browser using WebAssembly.

* [gbe-plus](https://github.com/shonumi/gbe-plus) ⭐ 591 | 🐛 80 | 🌐 C++ | 📅 2026-06-10 - A recently rewritten emulator that has a large effort in preserving the functions of obscure accessories (such as IR link, Mobile Network GB, Barcode Boy, GB Printer, local and online GB Serial Link Cable, ... )
...
* [ZGB](https://github.com/Zal0/ZGB) ⭐ 787 | 🐛 10 | 🌐 C++ | 📅 2024-08-01 - A little engine for creating games for the original Game Boy (expands gbdk, more info [here](http://zalods.blogspot.com/2017/01/zgb-little-engine-for-game-boy.html)).
* [Retr0 GB](https://bitbucket.org/HellSuffering/retr0-gb/) - An engine for creating games (expands GBDK).

#### Development tools

* [mgbdis](https://github.com/mattcurrie/mgbdis) ⭐ 312 | 🐛 12 | 🌐 Assembly | 📅 2026-05-26 - Game Boy ROM disassembler with RGBDS compatible output.
...
* [Tilemap Studio](https://github.com/Rangi42/tilemap-studio) ⭐ 516 | 🐛 25 | 🌐 C++ | 📅 2026-05-02 - A tilemap editor for Game Boy, Color, Advance, and SNES projects. Written in C++ with FLTK.
* [Superfamiconv](https://github.com/Optiroc/SuperFamiconv) ⭐ 183 | 🐛 23 | 🌐 C++ | 📅 2025-02-19 - Flexible and composable tile graphics converter supporting Super Nintendo, Game Boy, Game Boy Color, Game Boy Advance, Mega Drive and PC Engine formats.
...
* [Game Boy LCD sniffing](https://github.com/svendahlstrand/game-boy-lcd-sniffing) ⭐ 181 | 🐛 0 | 🌐 C | 📅 2017-08-11 - Sniff your Game Boy's LCD using a logic analyzer.
...
* [hUGETracker](https://github.com/SuperDisk/hUGETracker) ⭐ 356 | 🐛 43 | 🌐 Pascal | 📅 2026-04-15 - A music tracker based on OpenMPT, focused on ease of use, compact output, and embeddability in homebrew games.
...
* [GBSoundSystem](https://github.com/gbdev/GBSoundSystem) ⭐ 19 | 🐛 0 | 🌐 Assembly | 📅 2023-05-09 - A modernized audio driver for GameBoy Tracker (aka the Paragon 5 music player).
...
* [GingerBread](https://github.com/ahrnbom/gingerbread) ⭐ 138 | 🐛 2 | 🌐 Assembly | 📅 2021-01-19 - A software library for making your own Game Boy games. It is made to be used alongside the book [Game Boy Assembly Programming for the Modern Game Developer](https://github.com/ahrnbom/gbapfomgd) ⭐ 167 | 🐛 0 | 🌐 TeX | 📅 2023-02-25 which also doubles as documentation.
...
* [rgbds-vscode](https://github.com/DonaldHays/rgbds-vscode) ⭐ 80 | 🐛 5 | 🌐 TypeScript | 📅 2025-11-06 - Visual Studio Code language extension for RGBDS GBZ80 Assembly.
* [Z80 Assembly support for Visual Studio Code](https://github.com/Imanolea/z80asm-vscode) ⭐ 36 | 🐛 0 | 📅 2025-08-16
* [Vim syntax file for RGBDS](https://github.com/Leandros/dotfiles/blob/master/.vim/syntax/rgbds.vim) ⭐ 11 | 🐛 3 | 🌐 Lua | 📅 2026-06-12 - Another Vim syntax highlighting file for RGBDS assembly.
...
* [8-Bit Wonderland](https://github.com/gb-archive/salvage/blob/master/misc/8bit_wonderland.pdf) ⭐ 40 | 🐛 2 | 🌐 HTML | 📅 2025-04-22 - Well-written introductory document about how the Game Boy works and how to start developing working code for it.
...
* [Pokered-gbc](https://github.com/dannye/pokered-gbc) ⭐ 177 | 🐛 2 | 🌐 Assembly | 📅 2026-01-25 - Pokémon Red remade with full GBC support.
...
* [Libbet and the Magic Floor](https://github.com/pinobatch/libbet) ⭐ 40 | 🐛 5 | 🌐 Python | 📅 2025-09-02
* [Geometrix](https://github.com/AntonioND/geometrix) ⚠️ Archived
* [GBSlides](https://github.com/Kartones/gameboy) ⭐ 32 | 🐛 0 | 🌐 Assembly | 📅 2026-02-28 - A simple Game Boy Powerpoint-like slides viewer.
...
* [Powa!](https://aiguanachein.itch.io/powa) - Side scrolling platformer for the Game Boy (Color)  ([ZGB engine](https://github.com/Zal0/ZGB/) ⭐ 787 | 🐛 10 | 🌐 C++ | 📅 2024-08-01).
* [Cavern](https://thegreatgallus.itch.io/cavern-mvm-9) - ([ZGB engine](https://github.com/Zal0/ZGB/) ⭐ 787 | 🐛 10 | 🌐 C++ | 📅 2024-08-01).
* [Mona and the Witch's Hat Deluxe](https://ctneptune.itch.io/mona-and-the-witchs-hat-dx) - ([ZGB engine](https://github.com/Zal0/ZGB/) ⭐ 787 | 🐛 10 | 🌐 C++ | 📅 2024-08-01).
* [Tobu Tobu Girl Deluxe](https://github.com/SimonLarsen/tobutobugirl-dx) ⭐ 93 | 🐛 1 | 🌐 C | 📅 2023-01-29 - An arcade platformer for the Game Boy (Color).
...
* [Petris](https://github.com/bbbbbr/Petris) ⭐ 34 | 🐛 0 | 🌐 C | 📅 2026-05-31 - A puzzle game of shapely pets for the Game Boy Color ([itch.io](https://bbbbbr.itch.io/petris)).
* [GBsnake](https://github.com/brovador/GBsnake) ⭐ 32 | 🐛 0 | 🌐 C++ | 📅 2017-04-23
* [Super Princess' 2092 Exodus](https://github.com/Zal0/gbjam2016) ⭐ 30 | 🐛 0 | 🌐 C | 📅 2022-11-02 - ([ZGB engine](https://github.com/Zal0/ZGB/) ⭐ 787 | 🐛 10 | 🌐 C++ | 📅 2024-08-01).
...
* [GBVideoPlayer2](https://github.com/LIJI32/GBVideoPlayer2) ⭐ 130 | 🐛 7 | 🌐 C | 📅 2019-11-02 - The second iteration of the above demo, which increases the resolution, adds *stereo- PCM audio, and introduces video compression*.
* [GBVideoPlayer](https://github.com/LIJI32/GBVideoPlayer) ⭐ 101 | 🐛 4 | 🌐 Python | 📅 2018-02-26 - A technical demo demonstrating how the Game Boy LCD controller can be hacked to make a Game Boy Color play a full motion video in color, together with music.
...
* [Pokémon Red/Blue](https://github.com/pret/pokered) ⭐ 4,753 | 🐛 20 | 🌐 Assembly | 📅 2026-06-12
* [Pokémon Crystal](https://github.com/pret/pokecrystal) ⭐ 2,449 | 🐛 57 | 🌐 Assembly | 📅 2026-06-12
* [Link's Awakening DX](https://github.com/mojobojo/LADX-Disassembly) ⭐ 887 | 🐛 19 | 🌐 Assembly | 📅 2026-06-03
* [Pokémon Yellow](https://github.com/pret/pokeyellow) ⭐ 851 | 🐛 3 | 🌐 Assembly | 📅 2026-06-07
* [Pokémon Gold and Silver](https://github.com/pret/pokegold) ⭐ 683 | 🐛 6 | 🌐 Assembly | 📅 2026-06-12
* [pokegold-spaceworld](https://github.com/pret/pokegold-spaceworld) ⭐ 385 | 🐛 14 | 🌐 Assembly | 📅 2026-06-13 - Pokémon Gold and Silver 1997 Space World demo.
* [Pokémon TCG](https://github.com/pret/poketcg) ⭐ 319 | 🐛 5 | 🌐 Assembly | 📅 2026-06-03
* [Oracle of Ages](https://github.com/drenn1/ages-disasm) ⭐ 199 | 🐛 0 | 🌐 Assembly | 📅 2026-06-13
* [Pokémon Pinball](https://github.com/pret/pokepinball) ⭐ 192 | 🐛 4 | 🌐 Assembly | 📅 2026-05-10
* [Tetris](https://github.com/vinheim3/tetris-gb-disasm) ⭐ 31 | 🐛 1 | 🌐 Assembly | 📅 2023-01-19 - Complete Tetris disassembly.
...
* [Arduino Gameboy Printer Emulator](https://github.com/mofosyne/arduino-gameboy-printer-emulator) ⭐ 363 | 🐛 3 | 🌐 C++ | 📅 2026-05-13 - Emulate a gameboy printer via the gameboy link cable.
...
* [Game Boy Printer Web](https://github.com/HerrZatacke/gb-printer-web) ⭐ 71 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-01 - Gallery app for to the Game Boy camera: import pictures from exports or cartridge dumps and choose color palettes.
...
* [ArduinoBoy](https://github.com/trash80/Arduinoboy) ⭐ 367 | 🐛 8 | 🌐 Max | 📅 2020-11-16 - Serial communication (MIDI) from an Arduino to the Game Boy for music applications such as LittleSoundDJ, Nanoloop, and mGB.
* [mGB](https://github.com/trash80/mGB) ⭐ 266 | 🐛 14 | 🌐 Assembly | 📅 2024-07-16 - A Game Boy cartridge program that enables the Game Boy to act as a full MIDI supported sound module.
...
* [gb-save-states](https://github.com/mattcurrie/gb-save-states) ⭐ 181 | 🐛 29 | 🌐 Assembly | 📅 2025-02-18 - Patches to add save state support to Game Boy games when playing on the original hardware.
...
* [GBCartRead](https://github.com/insidegadgets/GBCartRead) ⭐ 69 | 🐛 2 | 🌐 Eagle | 📅 2016-07-21 - Read ROM, Read RAM or Write RAM from/to a GameBoy Cartridge.
...
* [The Game Boy Archive - Salvage](https://github.com/gb-archive/salvage) ⭐ 40 | 🐛 2 | 🌐 HTML | 📅 2025-04-22 - Historical archive of software, old articles, FAQs and various documents.
...
Thanks to [every](https://github.com/avivace/awesome-gbdev/graphs/contributors) ⭐ 4,450 | 🐛 22 | 📅 2026-06-13 contributor of this project, Jeff Frohwein, Pascal Felber, KOOPa, Pan of Anthrox, GABY, Marat Fayzullin, Paul Robson, BOWSER, neviksti, Martin "nocash" Korth, Nitro2k01, Duo, Chris Antonellis, Michael Hope, Beware, Jonathan “Lord Nightmare” Gevaryahu, Carsten Sorense, Sindre Aamås, Otaku No Zoku, GeeBee.
